...
const Detailleaccuille = () => {
  ...
  return (
    <>
     <Header></Header>
    <div className="dashboard-main-wrapper" style={{ marginTop: '20px' }}>
    ...
    <div>
      ...
      <ul class="nav nav-tabs border-0" id="myTab" role="tablist">
        ...
        <li class="nav-item"><a class="nav-link text-uppercase" id="reviews-tab" data-bs-toggle="tab" href="/" role="tab" aria-controls="reviews" aria-selected="false"  >Retour</a></li>
      </ul>
      <div class="tab-content mb-5" id="myTabContent" >
            <div class="col-12 grid-margin stretch-card ajout_commision" ref={validation}>
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Avoir une conversation avec le propriétaire.</h4>
                  <a href={"/login" } >
...
export default Detailleaccuille;
