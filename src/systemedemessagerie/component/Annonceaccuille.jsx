...
import Favorie from '../syclass/Favorie';
import StarRating from './StarRating';

import FavorieButton from './FavorieButton';
function Annonceaccuille(props) {
         ...
         <div class="col  cadre_body">
                        <div class="card h-100 ">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href={"/detailleaccuille/" + v_liste_annonce.idcaracteristique} >Detaille</a></div>
                            </div>
                        </div>
                    </div>
    </>
...
export default Annonceaccuille;